package com.Project.WebServices.JMoviesWeb.service;
...
import com.Project.WebServices.JMoviesWeb.dataBase.*;
/**
...
public class UserService {
	...
	public void CreateUser (User user) {
		try {
			...
			System.out.print("Avec REST, User ayant l'id = "+user.getUser_id()+" ayant pour User name "+user.getUserName()+" et aimant les films "+user.getPreference()+" à été ajouté.\n");
	...
	public void addReviews(Review review) {
		try {
			...
			preparedStatement.close();
			System.out.print("Avec REST, La review ayant l'id = "+NewId+" ayant comme titre de film "
